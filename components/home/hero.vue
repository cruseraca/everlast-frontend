    ...
    <div class="mx-auto max-w-7xl">
      ...
      >
        ...
        >
          ...
          <span
            class="relative mt-2 text-transparent bg-clip-text bg-gradient-to-br from-green-600 to-green-500 md:inline-block"
        ...
        <div class="flex flex-col items-center mt-12 text-center">
          <span class="relative inline-flex w-full md:w-auto">
            <a
              href="#_"
              type="button"
              class="inline-flex items-center justify-center w-full px-8 py-4 text-base font-bold leading-6 text-white bg-green-600 border border-transparent md:w-auto hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-600 rounded-xl"
            >
              Purchase Now
            </a>
            <span
          ...
          <a href="#" class="mt-3 text-sm text-green-600">Learn More</a>
        </div>
      </div>
